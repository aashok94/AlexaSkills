...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Hello! Welcome to my birthday. This should be fun! Can you tell me your birthday?"
...
class BirthdayLaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if now_date != next_birthday:
            ...
            speak_output = "Welcome back to my birthday skill. It looks like there are \
...
class BirthdayIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("BirthdayInfoIntent")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        speak_output = 'Oh cool! I will remember that you were born {month} {day} {year}.'.format(month=month, day=day, year=year)
...
sb.add_request_handler(BirthdayLaunchRequestHandler())
